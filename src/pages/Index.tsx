...
const Index = () => {
  ...
  return (
    <AppFrame
      sidebar={
        <div className="space-y-3" id="styles">
          ...
          <div className="rounded-2xl border border-border bg-card/80 p-4 text-sm">
            ...
            <p className="text-muted-foreground">❤️ Loves: {stats.loves}</p>
            <p className="text-muted-foreground">✨ Reactions: {stats.reactions}</p>
          </div>
        </div>
      }
    >
      ...
      <main className="container px-4 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-5 sm:space-y-7">
        ...
        <div className="lg:hidden" id="styles">
          <ColorModePicker mode={mode} onModeChange={setMode} />
        </div>
